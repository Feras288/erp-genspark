// Phase 5: Purchases Core — create DTO.
// Mirrors CreateSalesInvoiceDto exactly. The field naming swap from "customer"
// to "supplier" is the only behavioural difference at the API surface.
...
export class CreatePurchaseInvoiceLineDto {
  ...
  @ApiProperty({
    required: false,
    description: 'Required for PRODUCT lines at receive time',
  })
  @IsOptional()
  @IsString()
  @Length(1, 64)
  ...
  @IsNumberString()
  @Matches(DECIMAL_QTY_REGEX, {
    message: 'unitCost must be a decimal up to 4 fractional digits',
  })
  unitCost!: string;
...
export class CreatePurchaseInvoiceDto {
  @ApiProperty({
    required: false,
    description: 'Partner of type SUPPLIER or BOTH',
  })
  @IsOptional()
  @IsString()
  @Length(1, 64)
